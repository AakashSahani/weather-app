...
function WeatherHighlights({ todayWeather }) {
	return (
		<>
			...
			<div className="bg-weeklyBg max-h-fit min-h-screen lg:min-h-fit lg:py-[5%] lg:px-[5%] p-10 lg:p-2 lg:grid lg:grid-cols-2 lg:items-start lg:justify-center lg:gap-2 flex flex-col  items-center justify-center w-full">
				<Highlights
					title="Humidity"
